        ...
        <div class="grid-container">
          <div class="grid-x">
            <div class="header_logo"><a href="index.php">
                <div class="logo">Аренда бытовок</div>
                <div class="logo_text">Аренда бытовок и блок контейнеров с 2008 г.</div></a></div>
            <div class="header_menu">
              <ul class="menu">
                <li><a href="rent.php">Аренда бытовки</a>
                  <ul class="submenu">
                    <li><a href="bytovka.php">Бытовка прорабская (офис)</a></li>
                    <li><a href="bytovka.php">Бытовка жилая</a></li>
                    <li><a href="bytovka.php">Бытовка душевая</a></li>
                    <li><a href="bytovka.php">Бытовка для зимнего проживания</a></li>
                    <li><a href="bytovka.php">Бытовка склад</a></li>
                    <li><a href="bytovka.php">Бытовка для строителей</a></li>
                    <li><a href="bytovka.php">Бытовка раздевалка</a></li>
                    <li><a href="bytovka.php">Бытовка столовая</a></li>
                  </ul>
                </li>
