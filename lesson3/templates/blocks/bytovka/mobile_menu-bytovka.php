<div class="mobile_menu">
      ...
      <div class="dropdown_menu">
        <ul class="menu">
          <li class="parent"><a href="rent.php">Аренда бытовки</a>
            <ul class="submenu">
              <li><a href="bytovka.php">Аренда бытовок в Видном</a></li>
              <li><a href="bytovka.php">Аренда бытовок в Домодедово</a></li>
              <li><a href="bytovka.php">Аренда бытовок в Видном</a></li>
              <li><a href="bytovka.php">Аренда бытовок в Домодедово</a></li>
              <li><a href="bytovka.php">Аренда бытовок в Видном</a></li>
              <li><a href="bytovka.php">Аренда бытовок в Домодедово</a></li>
