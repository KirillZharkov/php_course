          ...
          <form class="form" action="register.php" method="post" autocomplete="off">
            <div class="form__row">
              ...
              <input class="form__input <?php if(isset($errors['email'])): ?> form__input--error<?php endif; ?>
                " type="text" name="email" id="email" value="<?php echo htmlspecialchars($fields['email']); ?>" placeholder="Введите e-mail">
            ...
            <div class="form__row">
              ...
              <input class="form__input <?php if(isset($errors['password'])): ?> form__input--error<?php endif; ?>" 
                ...
                value="<?php echo htmlspecialchars($fields['password']); ?>" placeholder="Введите пароль">
            ...
            <div class="form__row">
              ...
              <input class="form__input <?php if(isset($errors['name'])): ?> form__input--error<?php endif; ?>" 
                ...
                value="<?php echo htmlspecialchars($fields['name']); ?>" placeholder="Введите имя">
